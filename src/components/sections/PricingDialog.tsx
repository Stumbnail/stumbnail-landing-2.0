...
function MergeIcon({ className = "w-4 h-4", style }: { className?: string; style?: React.CSSProperties }) {
    return (
...
function WandIcon({ className = "w-4 h-4", style }: { className?: string; style?: React.CSSProperties }) {
    return (
        <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M15 4V2" />
            <path d="M15 16v-2" />
...
function YouTubeIcon({ className = "w-4 h-4", style }: { className?: string; style?: React.CSSProperties }) {
    return (
        <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function ImageIcon({ className = "w-4 h-4", style }: { className?: string; style?: React.CSSProperties }) {
    return (
        <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function LayersIcon({ className = "w-4 h-4", style }: { className?: string; style?: React.CSSProperties }) {
    return (
        <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function LockIcon({ className = "w-4 h-4", style }: { className?: string; style?: React.CSSProperties }) {
    return (
        <svg className={className} style={style} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                        ...
                        >
                            <div className="space-y-5">
                                ...
                                <ul className="space-y-3">
                                    {features.map((feature, i) => (
                                        <li
                                            ...
                                            style={{ color: 'var(--color-foreground)' }}
                                        >
                                            <feature.icon className="w-4 h-4 shrink-0" style={{ color: 'var(--color-text-muted)' }} />
                                ...
                                <a
                                    ...
                                    className="block w-full py-3 px-6 rounded-xl font-semibold text-center transition-colors duration-200"
                                    style={{
                        ...
                        >
                            {/* Best Value Badge */}
                            <div
                                className="absolute -top-3 left-1/2 -translate-x-1/2 flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide shadow-lg"
                                style={{
                            ...
                            <div className="space-y-5">
                                <div>
                                    <p className="text-sm font-medium uppercase tracking-wider text-[#ff6f61]">Pro</p>
                                    <div className="mt-3 flex items-baseline gap-1">
                                        <span
                                            className="text-4xl md:text-5xl font-bold tracking-tight"
                                            style={{ color: 'var(--color-foreground)' }}
                                ...
                                <ul className="space-y-3">
                                    {features.map((feature, i) => (
                                        <li
                                            ...
                                            style={{ color: 'var(--color-foreground)' }}
                                        >
                                            <feature.icon className="w-4 h-4 shrink-0 text-[#ff6f61]" />
                                            <span>{feature.text}</span>
                                        </li>
                                    ))}
                                </ul>
                                ...
                                <a
                                    href="https://app.stumbnail.com/login"
                                    className="block w-full py-3 px-6 rounded-xl font-bold text-center text-white transition-colors duration-200 shadow-lg"
                                    style={{
                                        backgroundColor: '#ff6f61',
                    ...
                    <div className="mt-8 text-center">
                        <p style={{ color: 'var(--color-text-muted)' }} className="text-sm">
                            ...
                            <a
                                href="https://app.stumbnail.com/login"
                                className="font-semibold underline underline-offset-4 transition-colors hover:text-[#ff6f61]"
                                style={{
                                    color: 'var(--color-foreground)',
