  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {/* Styled Connection Line - Flowing Animation */}
        {/* Styled Connection Line - Flowing Animation */}
        <div className="flex justify-end mb-2">
          ...
          >
            ...
            {/* 
                We use a simpler CSS mask approach for the flow effect to be reliable across browsers. 
                The path fill is solid, but the mask moves.
             */}
            <path
