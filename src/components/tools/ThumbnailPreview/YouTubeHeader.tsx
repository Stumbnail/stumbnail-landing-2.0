...
export function YouTubeHeader({ searchValue = '', variant = 'default' }: YouTubeHeaderProps) {
    return (
        <div className="flex items-center justify-between px-4 py-2 border-b" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-background)' }}>
            {/* Left Section: Menu + Logo */}
            <div className="flex items-center gap-4">
                {/* Hamburger Menu */}
                <button className="p-2 rounded-full hover:bg-[var(--color-button-bg)] transition-colors" style={{ color: 'var(--color-foreground)' }}>
                ...
                <div className="flex items-center gap-0.5">
                    ...
                    <span className="text-lg font-semibold tracking-tighter" style={{ color: 'var(--color-foreground)' }}>YouTube</span>
                </div>
            </div>
            ...
            <div className="flex-1 max-w-xl mx-4">
                <div className="flex items-center">
                    ...
                    <button
                        className="px-5 py-[7px] rounded-r-full flex items-center justify-center"
                    ...
                    >
                        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{ color: 'var(--color-text-muted)' }}>
            ...
            <div className="flex items-center gap-2">
                {/* Create Button */}
                <button className="p-2 rounded-full hover:bg-[var(--color-button-bg)] transition-colors" style={{ color: 'var(--color-text-muted)' }}>
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                ...
                {/* Profile Avatar */}
                <div className="w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center ml-1 cursor-pointer">
